...
| S-004 | open | security/auth | Shared admin API key model is too weak for remote beta / GCP deployment | `issues/admin_auth_model_too_weak_for_remote_beta.md` | — | — | Define the remote admin security model before public beta; device token model is stronger than the admin model today |
