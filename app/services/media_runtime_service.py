...
from .report_image_runtime_service import ReportImageRuntimeService
...
class MediaRuntimeService:
    ...
    def __init__(
        ...
        *,
        ...
        self._logger = logger
        self._report_images = ReportImageRuntimeService(
            db_store=db_store,
    ...
    def load_job_report_images(
        ...
        *,
        ...
        return self._report_images.load_job_report_images(
            job_id=job_id,
            round_id=round_id,
        )
    ...
    def load_effective_job_report_images(
        ...
        *,
        ...
        """
        return self._report_images.load_effective_job_report_images(
            job_id=job_id,
    ...
    def merge_report_images(*image_lists: list[dict[str, Any]] | None) -> list[dict[str, str]]:
        ...
        """
        return ReportImageRuntimeService.merge_report_images(*image_lists)
    ...
    def build_report_image_variant(source_path: Path, report_path: Path) -> tuple[Path, int]:
        ...
        return ReportImageRuntimeService.build_report_image_variant(source_path, report_path)
